function ddir = specfem3d_input_setup_flat(ddir, bottom, depth, freq, baz, theta, gpu_mode)
% ddir = SPECFEM3D_INPUT_SETUP_FLAT(ddir, bottom, depth, freq, baz, theta, gpu_mode)
%
...
% freq          maximum frequency of the simulation (used for source-time
%               function of the plane wave and low-pass filter)
